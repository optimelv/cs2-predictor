window.__STRIKESIGNAL_DATA__ = {
  ...
  "generated_at_utc": "2026-06-13T00:07:22Z",
  "major_projection": {
    "buckets": {
      "advance": [
        {
  ...
  "updater": {
    "detail": "Stage 3 results and current pairings verified against the live Major board; model state retained from the warehouse snapshot.",
    "status": "verified_major_state_refresh"
  }
};
