...
const fixture = {
  ...
  matches: [
    { match_id: "1", match_date: "2026-06-01", tier: "tier_1", team1_name: "Alpha", team2_name: "Beta", winner_name: "Alpha", stage_name: "Quarterfinals", round_name: "Upper quarterfinal", phase: "quarterfinal", lineups: { team1: ["a", "b", "c", "d", "e"], team2: [] }, maps: [{ map_name: "Mirage", winner_name: "Alpha", score1: 13, score2: 8 }] },
...
const preserved = mergeHistoryMatches(fixture, [{
  match_id: "1", match_date: "2026-06-01", tier: "tier_1", team1_name: "Alpha", team2_name: "Beta",
  status: "finished", stage_name: "Completed series", round_name: "", phase: "regular", maps: [], lineups: { team1: [], team2: [] },
}]).matches.find((match) => match.match_id === "1");
assert.equal(preserved.maps.length, 1);
assert.equal(preserved.lineups.team1.length, 5);
assert.equal(preserved.stage_name, "Quarterfinals");
assert.equal(preserved.round_name, "Upper quarterfinal");
assert.equal(preserved.phase, "quarterfinal");
